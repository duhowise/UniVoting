...
namespace UniVoting.Client
{
	...
	public partial class MainWindow : FluentWindow
	{
		...
		public MainWindow(ICacheService cacheService)
		{
        ...
        public void Initialize(Stack<Position> positionsStack, Voter voter)
        {
	    ...
	    private void ProcessVote()
	    {
	        ...
	        {
	            _voter.Voted = true;
	            var completedPage = App.GetService<ClientVoteCompletedPage>();
	            completedPage.Initialize(_votes, _voter, _skippedVotes);
	            completedPage.Show();
	            Hide();
	        }
	    }
	...
	private async void MainWindow_Loaded(object sender, RoutedEventArgs e)
		{
		 PageHolder.Content = VotingPageMaker(_positionsStack);
			...
			// Note: VotingService should be injected as instance service
