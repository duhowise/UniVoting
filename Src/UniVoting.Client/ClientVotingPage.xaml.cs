...
namespace UniVoting.Client
{
    ...
    public partial class ClientVotingPage : Page
    {
        ...
        private void ClientVotingPage_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            if (string.IsNullOrWhiteSpace(_position.Faculty.FacultyName) || _position.Faculty.FacultyName.Trim().Equals(_voter.Faculty.FacultyName, StringComparison.OrdinalIgnoreCase))
            {
